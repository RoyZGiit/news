...
def build_site() -> None:
    ...
    try:
        ...
        # Fetch latest articles for the index page — balanced mix from all sources
        # Get recent articles from each source to ensure diversity
        all_latest = []
        source_names = (
            session.execute(
